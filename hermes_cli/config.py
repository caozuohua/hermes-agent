...
DEFAULT_CONFIG = {
    ...
    # Optional pre-exec security scanning via tirith
    "security": {
...
# tirith pre-exec scanning is disabled by default for lightweight/stable
# profiles. Configure via security.tirith_* keys or env vars
