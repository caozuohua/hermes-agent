...
def _resolve_update_branch(args) -> str:
    ...
    A configured branch lets fork deployments keep the CLI, dashboard, and
    gateway update surfaces on a tested release branch.  Explicit
...
def cmd_tools(args):
    ...
    elif action == "budget-check":
        from hermes_cli.tools_config import tools_budget_check_command

        sys.exit(tools_budget_check_command(args))
